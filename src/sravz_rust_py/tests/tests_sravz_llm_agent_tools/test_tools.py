...
class TestTools(unittest.TestCase):
    ...
    def test_login_guest_integration(self):
        self.assertIsNotNone(tools.get_bearer_token())

    def test_get_market_news_integration(self):
        self.assertIsNotNone(tools.get_market_news())
